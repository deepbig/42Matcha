...
const Filter = () => {
	...
	return (
		<div className='profile-container'>
			...
			<div className='profile-description'>In this page, you can change your matching preference :></div>
			<div className='profile-section'>
				<form name='profile_filter' onSubmit={_handleForm}>
					...
					<label className='profile-input-label-last'>
						...
						<input type='number' min='0' className='profile-input' name='preference_max_distance' defaultValue={user.data.preference_max_distance} placeholder='No Preference' />
					</label>
